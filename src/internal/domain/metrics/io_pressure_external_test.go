...
// TestNewIOPressure tests the NewIOPressure constructor.
func TestNewIOPressure(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			// Create IOPressure using constructor.
			pressure := metrics.NewIOPressure(tt.params)
...
// TestIOPressure_IsUnderPressure tests the IsUnderPressure method on IOPressure.
func TestIOPressure_IsUnderPressure(t *testing.T) {
	t.Parallel()
