...
// TestMemoryPressureParams_Fields tests MemoryPressureParams struct fields.
func TestMemoryPressureParams_Fields(t *testing.T) {
	tests := []struct {
		name   string
		...
		{
			name: "all_fields_set",
			params: metrics.MemoryPressureParams{PressureParams: metrics.PressureParams{
				SomeAvg10:  10.5,
				SomeAvg60:  8.0,
				SomeAvg300: 5.0,
				SomeTotal:  12345,
