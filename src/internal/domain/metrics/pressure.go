...
// NewPressure creates a new Pressure instance from parameters.
//
// Params:
//   - params: the pressure parameters containing all metrics.
//
// Returns:
//   - *Pressure: a new pressure instance.
func NewPressure(params *PressureParams) *Pressure {
	// Create pressure instance from params.
	return &Pressure{
