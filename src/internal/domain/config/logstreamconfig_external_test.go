// Package config_test provides black-box tests for LogStreamConfig.
package config_test
...
func TestLogStreamConfig_File(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			cfg := config.NewLogStreamConfig(tt.filePath)
...
func TestLogStreamConfig_TimestampFormat(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			cfg := config.LogStreamConfig{Format: tt.format}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			cfg := config.LogStreamConfig{
				RotationConfig: config.RotationConfig{MaxFiles: tt.maxFiles},
			}
