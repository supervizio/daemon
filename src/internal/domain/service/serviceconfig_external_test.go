// Package service_test provides black-box tests for ServiceConfig.
...
func TestServiceConfig_NewServiceConfig(t *testing.T) {
	...
	tests := []struct {
		...
		expectedPolicy  service.RestartPolicy
		expectedRetries int
	...
	}{
		{
			...
			expectedPolicy:  service.RestartOnFailure,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			cfg := service.NewServiceConfig(tt.serviceName, tt.command)
