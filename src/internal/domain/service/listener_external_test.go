...
func TestNewListenerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			listener := service.NewListenerConfig(tt.listenerName, tt.port)
...
func TestListenerConfig_WithTCPProbe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			listener := service.NewListenerConfig(tt.listenerName, tt.port).WithTCPProbe()
...
func TestListenerConfig_WithHTTPProbe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			listener := service.NewListenerConfig("http", 8080).WithHTTPProbe(tt.path)
...
func TestListenerConfig_WithGRPCProbe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create a listener and add gRPC probe with service.
			listener := service.NewListenerConfig("grpc", 50051).WithGRPCProbe(tt.serviceName)
...
func TestListenerConfig_ChainedProbes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var listener service.ListenerConfig
