...
func TestNewTCPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewTCPTarget(tt.address)
...
func TestNewUDPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewUDPTarget(tt.address)
...
func TestNewHTTPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewHTTPTarget(tt.address, tt.method, tt.statusCode)
...
func TestNewGRPCTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewGRPCTarget(tt.address, tt.service)
...
func TestNewExecTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewExecTarget(tt.command, tt.args...)
...
func TestNewICMPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := healthcheck.NewICMPTarget(tt.address)
