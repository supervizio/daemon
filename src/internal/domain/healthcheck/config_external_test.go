...
func TestNewConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedTimeout:  healthcheck.DefaultTimeout,
			expectedInterval: healthcheck.DefaultInterval,
			expectedSuccess:  healthcheck.DefaultSuccessThreshold,
			expectedFailure:  healthcheck.DefaultFailureThreshold,
		},
	}
...
func TestConfig_WithTimeout(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg := healthcheck.NewConfig().WithTimeout(tt.timeout)
...
func TestConfig_WithInterval(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg := healthcheck.NewConfig().WithInterval(tt.interval)
...
func TestConfig_WithSuccessThreshold(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg := healthcheck.NewConfig().WithSuccessThreshold(tt.threshold)
...
func TestConfig_WithFailureThreshold(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create config with custom threshold.
			cfg := healthcheck.NewConfig().WithFailureThreshold(tt.threshold)
...
func TestConfig_Validate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectError: true,
			expectedErr: healthcheck.ErrInvalidTimeout,
		},
		{
			...
			expectError: true,
			expectedErr: healthcheck.ErrInvalidInterval,
		},
		{
			...
			expectError: true,
			expectedErr: healthcheck.ErrInvalidSuccessThreshold,
		},
		{
			...
			expectError: true,
			expectedErr: healthcheck.ErrInvalidFailureThreshold,
		},
	}
