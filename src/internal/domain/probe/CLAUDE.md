...
├── process.go          # ProcessMetrics, ProcessState
└── port.go             # Collector interfaces
```
...
| `ProcessState` | Process lifecycle state enum |
...
- Used by: `application/metrics`, `infrastructure/probe/linux`
...
type MetricsMonitor struct {
    collector probe.SystemCollector
}
