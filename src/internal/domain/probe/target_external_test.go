...
func TestNewTCPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewTCPTarget(tt.address)
...
func TestNewUDPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewUDPTarget(tt.address)
...
func TestNewHTTPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewHTTPTarget(tt.address, tt.method, tt.statusCode)
...
func TestNewGRPCTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewGRPCTarget(tt.address, tt.service)
...
func TestNewExecTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewExecTarget(tt.command, tt.args...)
...
func TestNewICMPTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create target.
			target := probe.NewICMPTarget(tt.address)
