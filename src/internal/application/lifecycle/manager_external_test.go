// Package lifecycle_test provides external tests for manager.go.
...
func createTestConfig(name, command string) *config.ServiceConfig {
...
func TestNewManager(t *testing.T) {
	tests := []struct {
		...
		name string
		// serviceName is the name for the test config.
		serviceName string
		// command is the command for the test config.
		command string
	}{
		{
