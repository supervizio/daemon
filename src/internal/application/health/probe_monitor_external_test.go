...
func (f *mockCreator) Create(proberType string, _ time.Duration) (probe.Prober, error) {
...
func TestNewProbeMonitor(t *testing.T) {
	tests := []struct {
		name            string
		config          health.ProbeMonitorConfig
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create monitor.
			monitor := health.NewProbeMonitor(tt.config)
...
func TestProbeMonitor_SetProcessState(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create monitor.
			monitor := health.NewProbeMonitor(health.ProbeMonitorConfig{})
...
func TestProbeMonitor_IsHealthy(t *testing.T) {
	tests := []struct {
		name     string
		setup    func(*health.ProbeMonitor)
		expected bool
	}{
		{
			name: "unhealthy_by_default",
			setup: func(_ *health.ProbeMonitor) {
		...
		{
			name: "healthy_when_running",
			setup: func(m *health.ProbeMonitor) {
