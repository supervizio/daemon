...
func (f *mockCreator) Create(proberType string, _ time.Duration) (healthcheck.Prober, error) {
...
func TestNewProbeMonitor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create monitor.
			monitor := apphc.NewProbeMonitor(tt.config)
...
func TestProbeMonitor_SetProcessState(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create monitor.
			monitor := apphc.NewProbeMonitor(apphc.ProbeMonitorConfig{})
...
func TestProbeMonitor_IsHealthy(t *testing.T) {
	tests := []struct {
		name     string
		setup    func(*apphc.ProbeMonitor)
		expected bool
	}{
		{
			name: "unhealthy_by_default",
			setup: func(_ *apphc.ProbeMonitor) {
		...
		{
			name: "healthy_when_running",
			setup: func(m *apphc.ProbeMonitor) {
