...
func TestNewICMPProberWithTCPFallback(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			prober := healthcheck.NewICMPProberWithTCPFallback(tt.timeout, tt.tcpPort)
...
func TestICMPProber_Type(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create ICMP prober.
			prober := healthcheck.NewICMPProber(time.Second)
...
func TestICMPProber_Probe_ContextCancellation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			prober := healthcheck.NewICMPProber(10 * time.Second)
