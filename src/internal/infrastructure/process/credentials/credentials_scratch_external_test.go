...
// Package credentials_test provides black-box tests for credential credentials.
...
func TestScratchManager_LookupUser(t *testing.T) {
	t.Parallel()
...
// TestScratchManager_LookupGroup tests group lookup behavior.
func TestScratchManager_LookupGroup(t *testing.T) {
	t.Parallel()
...
// TestScratchManager_ResolveCredentials tests credential resolution.
func TestScratchManager_ResolveCredentials(t *testing.T) {
	t.Parallel()
...
// TestScratchManager_ApplyCredentials tests applying credentials to command.
func TestScratchManager_ApplyCredentials(t *testing.T) {
	t.Parallel()
