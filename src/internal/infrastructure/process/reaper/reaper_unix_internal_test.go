...
// Returns:
//   - none
func Test_Reaper_reapAll(t *testing.T) {
...
// Test_Reaper_reapLoop tests the reapLoop method.
//
// Params:
//   - t: the testing context
//
// Returns:
//   - none
func Test_Reaper_reapLoop(t *testing.T) {
...
// Test_Reaper_reapLoopWithSIGCHLD tests reapLoop SIGCHLD handling.
//
// Params:
//   - t: the testing context
//
// Returns:
//   - none
func Test_Reaper_reapLoopWithSIGCHLD(t *testing.T) {
