...
// Package process_test provides black-box tests for the adapters package.
...
// Returns:
//   - (none, test function)
func TestControl_SetProcessGroup(t *testing.T) {
...
// TestControl_GetProcessGroup tests the GetProcessGroup method.
//
// Params:
//   - t: the testing context
//
// Returns:
//   - (none, test function)
func TestControl_GetProcessGroup(t *testing.T) {
