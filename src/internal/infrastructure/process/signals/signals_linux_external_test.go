...
// TestManager_SetSubreaper tests the SetSubreaper method.
//
// Params:
...
// Returns:
//   - (none, test function)
func TestManager_SetSubreaper(t *testing.T) {
...
// TestManager_ClearSubreaper tests the ClearSubreaper method.
//
// Params:
//   - t: the testing context
//
// Returns:
//   - (none, test function)
func TestManager_ClearSubreaper(t *testing.T) {
...
// TestManager_IsSubreaper tests the IsSubreaper method.
//
// Params:
//   - t: the testing context
//
// Returns:
//   - (none, test function)
func TestManager_IsSubreaper(t *testing.T) {
