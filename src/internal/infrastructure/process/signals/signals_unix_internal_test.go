...
// Test_Manager_ForwardToSelf tests the Forward method with self-signaling.
//
// Params:
...
// Returns:
//   - none
func Test_Manager_ForwardToSelf(t *testing.T) {
...
// Test_Manager_ForwardErrorPath tests that the Forward method
...
// Returns:
//   - none
func Test_Manager_ForwardErrorPath(t *testing.T) {
