...
func TestNewUDPProber(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			prober := probe.NewUDPProber(tt.timeout)
...
func TestNewUDPProberWithPayload(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			prober := probe.NewUDPProberWithPayload(tt.timeout, tt.payload)
...
func TestUDPProber_Type(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create UDP prober.
			prober := probe.NewUDPProber(time.Second)
...
func TestUDPProber_Probe_WithCustomPayload(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Create UDP prober with custom payload.
			prober := probe.NewUDPProberWithPayload(time.Second, tt.payload)
