# Linux Probe Infrastructure Package
...
|------|------------|-------------|
| `CPUCollector` | `probe.CPUCollector` (partial) | Reads CPU metrics from /proc/stat and /proc/[pid]/stat |
| `MemoryCollector` | `probe.MemoryCollector` (partial) | Reads memory metrics from /proc/meminfo and /proc/[pid]/status |
...
To implement the full `probe.SystemCollector` interface, add:
