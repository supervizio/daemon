...
// Package adapters provides credential management for scratch containers.
...
// ScratchCredentialManager implements CredentialManager for scratch containers.
// It only supports numeric UID/GID values since /etc/passwd is not available.
type ScratchCredentialManager struct{}

// NewScratchCredentialManager creates a new ScratchCredentialManager instance.
func NewScratchCredentialManager() *ScratchCredentialManager {
	return &ScratchCredentialManager{}
}
...
func (m *ScratchCredentialManager) LookupGroup(nameOrID string) (*ports.Group, error) {
...
func (m *ScratchCredentialManager) ResolveCredentials(username, groupname string) (uid, gid uint32, err error) {
...
func (m *ScratchCredentialManager) ApplyCredentials(cmd *exec.Cmd, uid, gid uint32) error {
