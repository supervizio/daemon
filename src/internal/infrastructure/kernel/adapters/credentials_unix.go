...
// Package adapters provides credential management for Unix systems.
...
// NewUnixCredentialManager creates a new UnixCredentialManager instance.
// This constructor initializes the credential manager for Unix-based systems.
//
// Returns:
//   - *UnixCredentialManager: a new credential manager instance
func NewUnixCredentialManager() *UnixCredentialManager {
	// Return a new empty instance of UnixCredentialManager.
	return &UnixCredentialManager{}
}

// NewCredentialManager creates a new CredentialManager.
// This is an alias for NewUnixCredentialManager for interface compatibility.
//
// Returns:
//   - *UnixCredentialManager: a new credential manager instance
func NewCredentialManager() *UnixCredentialManager {
	// Return a new instance using the primary constructor.
	return NewUnixCredentialManager()
}
