//! BSD platform implementation (FreeBSD, OpenBSD, NetBSD)
//!
...
impl SystemCollector for BsdCollector {
...
struct BsdCPUCollector;

impl CPUCollector for BsdCPUCollector {
...
struct BsdLoadCollector;

impl LoadCollector for BsdLoadCollector {
...
struct BsdDiskCollector;

impl DiskCollector for BsdDiskCollector {
...
struct BsdNetworkCollector;

impl NetworkCollector for BsdNetworkCollector {
...
struct BsdIOCollector;

impl IOCollector for BsdIOCollector {
